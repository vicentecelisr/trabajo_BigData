...
nacionalidad <- c(here::here("imagenes", "r-belgica.png"), here::here("imagenes", "Flag_of_England.svg"), here::here("imagenes", "scotland.png"), here::here("imagenes", "Egypt.svg"), here::here("imagenes", "Spain.svg.webp"), here::here("imagenes", "South_Korea.svg"), here::here("imagenes", "Algeria.svg"), here::here("imagenes", "Spain.svg.webp"), here::here("imagenes", "Flag_of_England.svg"), here::here("imagenes", "Brazil.svg.png"))



asistencia %>% gt() %>% 
  gt::text_transform(locations = cells_body(columns = vars(nacionalidad)),
                     fn = function(x) {gt::web_image(x, height = 50)}) %>% tab_header(title = md("**Maximos Asistidores**"),subtitle = md("**Temporada 2019/2020**")) %>%
